...
When triggered, apply the Forward Edge-AI brand guidelines to ensure consistent, professional output across all document types. The brand guidelines are detailed in `.claude/skills/feai-brand/references/brand_guidelines.md` and should be referenced for specific color codes, font specifications, and gradient patterns.
...
### Logos
Three logo files are available in `.claude/skills/feai-brand/assets/`:
...
1. **Read brand guidelines**: Load `.claude/skills/feai-brand/references/brand_guidelines.md` for complete specifications
2. **Select appropriate logos**: Choose from `.claude/skills/feai-brand/assets/` based on background color
...
- **Reference file**: Consult `.claude/skills/feai-brand/references/brand_guidelines.md` for detailed specifications and examples
