...
Create content for each platform using the templates in `.claude/skills/social-media-generator/assets/`:

**Twitter** (`.claude/skills/social-media-generator/assets/twitter_template.md`)
...
**Instagram** (`.claude/skills/social-media-generator/assets/instagram_template.md`)
...
**LinkedIn** (`.claude/skills/social-media-generator/assets/linkedin_template.md`)
...
**Facebook** (`.claude/skills/social-media-generator/assets/facebook_template.md`)
...
This skill includes template files in the `.claude/skills/social-media-generator/assets/` directory:
