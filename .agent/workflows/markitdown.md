---
description: Convert various file formats (PDF, Office documents, images, audio, web content, structured data) to Markdown optimized for LLM processing.
---
...
See `.claude/skills/markitdown/references/document_conversion.md` for detailed documentation on document-specific features.
...
See `.claude/skills/markitdown/references/media_processing.md` for advanced media handling options.
...
See `.claude/skills/markitdown/references/web_content.md` for web extraction details.
...
See `.claude/skills/markitdown/references/structured_data.md` for format-specific options.
...
See `.claude/skills/markitdown/references/advanced_integrations.md` for integration details.
...
```bash
python .claude/skills/markitdown/scripts/batch_convert.py /path/to/documents /path/to/output
```

See `.claude/skills/markitdown/scripts/batch_convert.py` for implementation details.
