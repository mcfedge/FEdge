---
description: Generate professional PowerPoint pitch decks for startups and businesses.
---
...
**Reference best practices:** For detailed guidance on each slide's content and structure, consult `.claude/skills/pitch-deck/references/pitch_deck_best_practices.md`. Search for specific sections using grep:

```bash
grep -A 10 "### [Slide Number]. [Slide Name]" .claude/skills/pitch-deck/references/pitch_deck_best_practices.md
```
...
```bash
python3 .claude/skills/pitch-deck/scripts/create_pitch_deck.py pitch_data.json output_filename.pptx
```
...
- `.claude/skills/pitch-deck/references/pitch_deck_best_practices.md` - Comprehensive guide covering:
