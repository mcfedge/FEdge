---
description: Generate professional business documents (proposals, business plans, or budgets) from templates.
---
...
1. **Project Proposal** - Professional proposals for client projects
   - Template: `.claude/skills/business-document-generator/assets/templates/Professional Proposal Template.pdf`
   - Use case: Pitching projects to clients, stakeholders

2. **Business Plan** - Comprehensive business planning documents
   - Template: `.claude/skills/business-document-generator/assets/templates/Comprehensive Business Plan Template.pdf`
   - Use case: Startup planning, investor presentations, strategic planning

3. **Annual Budget** - Detailed budget planning documents
   - Template: `.claude/skills/business-document-generator/assets/templates/Annual Budget Plan Template.pdf`
...
Create a JSON file with the document data. Reference the data schemas in `.claude/skills/business-document-generator/references/document_schemas.md` for field requirements.
...
**Note:** Check `.claude/skills/business-document-generator/assets/examples/` for complete example JSON files:
...
```bash
python3 .claude/skills/business-document-generator/scripts/generate_document.py <document_type> <data_file> \
  --templates-dir .claude/skills/business-document-generator/assets/templates \
...
- `--templates-dir`: Directory containing PDF templates (default: `.claude/skills/business-document-generator/assets/templates`)
- `--output-dir`: Where to save generated PDFs (default: `output`)
- `--output-filename`: Optional custom filename

**Example:**
```bash
python3 .claude/skills/business-document-generator/scripts/generate_document.py proposal my_proposal_data.json \
  --templates-dir .claude/skills/business-document-generator/assets/templates \
...
2. Create a JSON data file with proposal fields (see `.claude/skills/business-document-generator/references/document_schemas.md`)

3. Run the script:
   ```bash
   python3 .claude/skills/business-document-generator/scripts/generate_document.py proposal proposal_data.json \
     --templates-dir .claude/skills/business-document-generator/assets/templates
   ```
...
3. Run the script:
   ```bash
   python3 .claude/skills/business-document-generator/scripts/generate_document.py business_plan plan_data.json \
     --templates-dir .claude/skills/business-document-generator/assets/templates
   ```
...
3. Run the script:
   ```bash
   python3 .claude/skills/business-document-generator/scripts/generate_document.py budget budget_data.json \
     --templates-dir .claude/skills/business-document-generator/assets/templates
   ```
...
The `.claude/skills/business-document-generator/scripts/generate_document.py` script:
...
Modify `.claude/skills/business-document-generator/scripts/generate_document.py` to add more sophisticated PDF manipulation as needed.

## Data Schema Reference

For detailed information about required and optional fields for each document type, consult:
- `.claude/skills/business-document-generator/references/document_schemas.md` - Complete data structure documentation

## Example Files

Find complete working examples in `.claude/skills/business-document-generator/assets/examples/`:
...
**Template not found:**
- Verify `--templates-dir` points to `.claude/skills/business-document-generator/assets/templates`
...
- Check that required fields are present (see `.claude/skills/business-document-generator/references/document_schemas.md`)

**Need to customize templates:**
- Original templates are in `.claude/skills/business-document-generator/assets/templates/`
