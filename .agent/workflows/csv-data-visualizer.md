---
description: Create interactive data visualizations, generate statistical plots, analyze data distributions, create dashboards, or perform automatic data profiling from CSV files.
---
...
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --histogram column_name --bins 30

# Box plot - show quartiles and outliers
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --boxplot column_name

# Box plot grouped by category
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --boxplot salary --group-by department

# Violin plot - distribution with probability density
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --violin column_name --group-by category
```

**Relationship Analysis:**
```bash
# Scatter plot with automatic trend line
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --scatter height weight

# Scatter plot with color and size encoding
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --scatter x y --color category --size value

# Correlation heatmap for all numeric columns
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --correlation
```

**Time Series:**
```bash
# Line chart for single variable
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --line date sales

# Multiple variables on same chart
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --line date "sales,revenue,profit"
```

**Categorical Data:**
```bash
# Bar chart (counts categories automatically)
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --bar category

# Pie chart for composition
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --pie region
```
...
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --histogram age -o output.html

# Static image formats
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --scatter x y -o plot.png
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --correlation -o heatmap.pdf
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --bar category -o chart.svg
```
...
**Text Report (default):**
```bash
python3 .claude/skills/csv-data-visualizer/scripts/data_profile.py data.csv
```

**HTML Report:**
```bash
python3 .claude/skills/csv-data-visualizer/scripts/data_profile.py data.csv -f html -o report.html
```

**JSON Report:**
```bash
python3 .claude/skills/csv-data-visualizer/scripts/data_profile.py data.csv -f json -o profile.json
```
...
```bash
python3 .claude/skills/csv-data-visualizer/scripts/create_dashboard.py data.csv
```

Custom output location:
```bash
python3 .claude/skills/csv-data-visualizer/scripts/create_dashboard.py data.csv -o my_dashboard.html
```

Control number of plots:
```bash
python3 .claude/skills/csv-data-visualizer/scripts/create_dashboard.py data.csv --max-plots 9
```

**Custom Dashboard from Config:**
Create a JSON configuration file specifying exact plots:
```bash
python3 .claude/skills/csv-data-visualizer/scripts/create_dashboard.py data.csv --config config.json
```
...
### Starting Analysis
1. **Always profile first** for unfamiliar datasets: `python3 .claude/skills/csv-data-visualizer/scripts/data_profile.py data.csv`
...
Consult `.claude/skills/csv-data-visualizer/references/visualization_guide.md` for detailed guidance. Quick reference:
...
```bash
# 1. Profile the data
python3 .claude/skills/csv-data-visualizer/scripts/data_profile.py sales_data.csv -f html -o profile.html

# 2. Create automatic dashboard
python3 .claude/skills/csv-data-visualizer/scripts/create_dashboard.py sales_data.csv -o dashboard.html

# 3. Dive deeper with specific plots
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py sales_data.csv --scatter price sales --color region
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py sales_data.csv --boxplot revenue --group-by product
```

### Report Generation
```bash
# Create specific visualizations for report
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --histogram age -o fig1_distribution.png
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --scatter income age -o fig2_correlation.png
python3 .claude/skills/csv-data-visualizer/scripts/visualize_csv.py data.csv --bar category -o fig3_categories.png

# Generate data summary
python3 .claude/skills/csv-data-visualizer/scripts/data_profile.py data.csv -f html -o data_summary.html
```
...
python3 .claude/skills/csv-data-visualizer/scripts/create_dashboard.py data.csv --config config.json -o presentation_dashboard.html
```
